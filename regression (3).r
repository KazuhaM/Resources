...
legend(locator(1), legend=c("2016","2017"),col=c(4,2),pch=c(1,4),cex=1.2)
...
plot(o16,add=T,col='blue',lwd=2,lty=2)
lines(o16,col='blue')
mtext(signif(o16$psi[2],2), side = 1, line = 0, at = o16$psi[2],col=4)
plot(o17, add=T,col='red',lwd=2,lty=4)
lines(o17,col='red')
mtext(signif(o17$psi[2],2), side = 1, line = 0, at = o17$psi[2],col=2)
plot(o,add=T,col='black')
lines(o,col='black')
mtext(signif(o$psi[2],2), side = 1, line = 0, at = o$psi[2],col=1)
legend(locator(1), legend=c("2016","2017"),col=c(4,2),pch=c(1,4),cex=1.2)
legend(locator(1), legend=c("2 years","2016","2017"),col=c(1,4,2),lty=c(1,2,4),cex=1.2)
...
text(25,500, paste("Break Point:",signif(o16$psi[2],3),
	"±",signif(o16$psi[3],3)),cex=1.2,adj=0)
text(25,470, paste("R^2 =",signif(o16.sum$r.squared,3)),cex=1.2,adj=0)
...
text(25,500, paste("Break Point:",signif(o17$psi[2],3),
	"±",signif(o17$psi[3],3)),cex=1.2,adj=0)
text(25,470, paste("R^2 =",signif(o17.sum$r.squared,3)),cex=1.2,adj=0)
...
lines(o,col=1)
mtext(signif(o$psi[2],2), side = 1, line = 0, at = o$psi[2],col=1)
text(25,500, paste("Break Point:",signif(o$psi[2],3),
	"±",signif(o$psi[3],3)),cex=1.2,adj=0)
text(25,470, paste("R^2 =",signif(o.sum$r.squared,3)),cex=1.2,adj=0)
###########################################################################
