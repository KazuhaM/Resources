...
legend(locator(1), legend=c("2016","2017"),col=c(4,2),pch=c(1,4))
legend(locator(1), legend=c("2 years","2016","2017"),col=c(1,4,2),lty=c(1,2,4))
...
text(30,500, paste("Break Point:",signif(o16$psi[2],3),
	"±",signif(o16$psi[3],3)))
text(30,480, paste("R^2 =",signif(o16.sum$r.squared,3)))
...
text(30,500, paste("Break Point:",signif(o17$psi[2],3),
	"±",signif(o17$psi[3],3)))
text(30,480, paste("R^2 =",signif(o17.sum$r.squared,3)))
...
text(30,500, paste("Break Point:",signif(o$psi[2],3),
	"±",signif(o$psi[3],3)))
text(30,480, paste("R^2 =",signif(o.sum$r.squared,3)))
###########################################################################
